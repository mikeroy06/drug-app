...
class DrugsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create drug" do
    assert_difference('Drug.count') do
      post drugs_url, params: { drug: { condition: @drug.condition, drug: @drug.drug, subcategory: @drug.subcategory } }
    end
  ...
  test "should update drug" do
    patch drug_url(@drug), params: { drug: { condition: @drug.condition, drug: @drug.drug, subcategory: @drug.subcategory } }
